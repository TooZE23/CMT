...
from dino_finetune.augmentations import get_train_augmentation
...
class NYU(Dataset):
    ...
    def __getitem__(self, index: int) -> Tuple[Tensor, Tensor]:
        ...
        rgb = os.path.join(*[self.root, self.split, 'image', item_name+'.jpg'])
        x1 = os.path.join(*[self.root, self.split, 'hha', item_name+'.png'])
        lbl_path = os.path.join(*[self.root, self.split, 'label', item_name+'.png'])
